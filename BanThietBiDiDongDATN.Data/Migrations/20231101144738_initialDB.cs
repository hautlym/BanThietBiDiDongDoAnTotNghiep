        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipNumberPhone = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ShipDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorScreen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StandScreen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Width = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TouchTech = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    TypePin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CapacityPin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypeSim = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberSim = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    HeadPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OtherConnect = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypeCharge = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifyBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
